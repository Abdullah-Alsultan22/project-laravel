...
<template>
    ...
    <div
        class="relative flex items-top justify-center min-h-screen bg-secondary dark:bg-primary sm:items-center sm:pt-0"
    >
        <div
            v-if="canLogin"
        ...
        >
            ...
            <template v-else>
                ...
                <Link
                    v-if="canRegister"
                    :href="route('register')"
                    class="ml-4 text-sm text-primary underline"
                >
                    Register
                </Link>
            </template>
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                <svg
                    ...
                    class="h-16 w-auto text-primary sm:h-20"
                >
            ...
            <div
                class="mt-8 bg-white dark:bg-secondary overflow-hidden shadow sm:rounded-lg"
            >
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold">
                                <a
                                    ...
                                    class="underline text-primary dark:text-white"
                                    >Documentation</a
                                >
                            </div>
                        </div>
                        ...
                        <div class="ml-12">
                            <div
                                class="mt-2 text-primary dark:text-secondary text-sm"
                            >
                    ...
                    <div
                        class="p-6 border-t border-secondary dark:border-primary md:border-t-0 md:border-l"
                    >
                        <div class="flex items-center">
                            <svg
                                fill="none"
                    ...
                    <div
                        class="p-6 border-t border-secondary dark:border-primary"
                    >
                        <div class="flex items-center">
                            <svg
                                fill="none"
                    ...
                    <div
                        class="p-6 border-t border-secondary dark:border-primary md:border-l"
                    >
                        <div class="flex items-center">
                            <svg
                                fill="none"
                            ...
                            <div
                                class="ml-4 text-lg leading-7 font-semibold text-primary dark:text-white"
                            >
                                Vibrant Ecosystem
                            </div>
                        </div>
            ...
            >
                <div class="text-center text-sm text-secondary sm:text-left">
                    <div class="flex items-center">
                        <svg
                            fill="none"
                            stroke-linecap="round"
                            ...
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                            class="-mt-px w-5 h-5 text-secondary"
                        >
                            <path
                        ...
                        <svg
                            ...
                            stroke-width="2"
                            viewBox="0 0 24 24"
                            class="ml-4 -mt-px w-5 h-5 text-secondary"
                        >
                            <path
                ...
                <div
                    class="ml-4 text-center text-sm text-secondary sm:text-right sm:ml-0"
                >
